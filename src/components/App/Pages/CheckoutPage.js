...
function CheckoutPage() {
  ...
  useEffect(() => {
    orderData.map((order_item) => {
      let price = order_item.price_in_cents/100;
      let singleTotalPrice = price * order_item.quantity;
          ...
          <div className="row">
            ...
            <div className="col-9">
              ...
              <div className="pl-5">
                ...
                <br />
                  <div>
                    <p>Number: {addressData.address_line_1}</p>
                    <p>Street: {addressData.address_line_2}</p>
